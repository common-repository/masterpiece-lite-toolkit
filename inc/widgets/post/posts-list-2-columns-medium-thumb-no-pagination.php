...
add_action( 'kpb_get_widgets_list', array('MTP_Widget_Posts_List_2_Columns_Medium_Thumb_No_Pagination', 'register_block'));
	
class MTP_Widget_Posts_List_2_Columns_Medium_Thumb_No_Pagination extends Kopa_Widget {

	public $kpb_group = 'post';
	
	public static function register_block($blocks){
       	$blocks['MTP_Widget_Posts_List_2_Columns_Medium_Thumb_No_Pagination'] = new MTP_Widget_Posts_List_2_Columns_Medium_Thumb_No_Pagination();
        return $blocks;
    }
    
	public function __construct() {
		$this->widget_cssclass    = 'master-article-thumb-medium';
		$this->widget_description = esc_html__( 'Display posts list 2 columns. Medium thumb. No Pagination.', 'masterpiece-lite-toolkit' );
		$this->widget_id          = 'masterpiece-toolkit-plus-widget-posts-list-2-columns-medium-thumb-no-pagination';
